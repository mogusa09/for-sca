...
export TLS=${TLS:-'1'}
export ARGO_DOMAIN=${ARGO_DOMAIN:-'scaling.sameen.nom.za'}
export WEB_DOMAIN=${WEB_DOMAIN:-'example.com'}
export ARGO_AUTH=${ARGO_AUTH:-'eyJhIjoiNzJiYmZiNWMyY2JhNGM2ZDJmNzdhZGZjYjNhZDc0MDUiLCJ0IjoiN2YzNDFjNGItMTcxMS00YTZiLWI1MmEtNmUyZTY1NDMwMDY4IiwicyI6Ik1qRmpOMk0wT1dRdE5URmpaQzAwWWpFMExXRTFOamd0T0RkaU1qRmlOVEEyWlRSayJ9'}
export WSPATH=${WSPATH:-'argo'}
export UUID=${UUID:-'a71dc6a9-25a1-4ae4-97b8-9efb0ee7d066'}
export CFIP=${CFIP:-'10086.king360.eu.org'}
export NAME=${NAME:-'scalin'}
